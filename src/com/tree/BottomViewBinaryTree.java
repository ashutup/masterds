...
public class BottomViewBinaryTree {
	...
	public static void main(String[] args) {
		...
		gatherBottomViewNodes(root, map, 0);
	...
	private static void gatherBottomViewNodes(TreeNode root,Map<Integer,TreeNode> map, int hd ) {
		if(root == null) {
			return;
		}
		...
		gatherBottomViewNodes(root.left, map, hd-1);
		gatherBottomViewNodes(root.right, map, hd+1);
